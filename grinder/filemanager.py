...
class GrinderFileManager:
    ...
    @exception_handler(expected_exception=GrinderFileManagerOpenError)
    def load_data_from_file(self, load_dir=DefaultValues.RESULTS_DIRECTORY, load_file=DefaultValues.JSON_RESULTS_FILE,
                            load_json_dir=DefaultValues.JSON_RESULTS_DIRECTORY) -> None:
    ...
    def write_results_json(self, results_to_write: list or dict, dest_dir: str, json_file: str,
                           json_dir=DefaultValues.JSON_RESULTS_DIRECTORY) -> None:
    ...
    def write_results_csv(self, results_to_write: list or dict, dest_dir: str, csv_file: str,
                          csv_dir=DefaultValues.CSV_RESULTS_DIRECTORY) -> None:
        if not results_to_write:
            return
    ...
    def write_results_txt(self, results_to_write: list or dict, dest_dir: str, txt_file: str,
                          txt_dir=DefaultValues.TXT_RESULTS_DIRECTORY) -> None:
        if not results_to_write:
            return
    ...
    def write_results_png(self, plot, dest_dir: str, png_file: str,
                          png_dir=DefaultValues.PNG_RESULTS_DIRECTORY) -> None:
        if not plot:
            return
